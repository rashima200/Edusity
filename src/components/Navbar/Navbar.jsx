  ...
  return (
    <nav className= {`container ${sticky? 'dark-nav' : ''}`}>
     ...
     <li><Link to= 'hero' smooth={true} offset={0} duration={500}>Home</Link></li>
      ...
      <li><Link to= 'testimonials' smooth={true} offset={0} duration={500}>Testominals</Link></li>
      <li><button Link to= 'contact' smooth={true} offset={0} duration={500} className='btn'>Contact us</button></li>
     </ul>
    </nav>
  )
}
